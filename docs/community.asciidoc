...
This helper implements the philosophy described in the https://www.elastic.co/guide/en/elasticsearch/guide/2.x/index-aliases.html[official documentation]
