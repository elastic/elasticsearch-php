...
* PHP 5.4.0 or higher (link:_php_version_requirement.html[see here for more details])
...
--------------------------
+
Client instantiation is performed with a static helper function `newBuilder()`.  This returns a ClientBuilder object,
