...
class ClusterNamespace extends AbstractNamespace
{
     ...
     * $params['return_200_for_cluster_health_timeout'] = (boolean) Whether to return HTTP 200 instead of 408 in case of a cluster health timeout from the server side
     *
     * @param array $params Associative array of parameters
     * @return array
