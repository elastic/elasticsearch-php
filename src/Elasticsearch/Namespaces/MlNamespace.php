...
class MlNamespace extends AbstractNamespace
{
     ...
     * $params['timeout']  = (time) Controls the amount of time to wait for the model to be deleted. (Default = 30s)
     *
     * @param array $params Associative array of parameters
     * @return array
     ...
     *
     * $params['model_id'] = (string) The ID of the trained model deployment stats to fetch
     *
     * @param array $params Associative array of parameters
     * @return array
     * @see https://www.elastic.co/guide/en/elasticsearch/reference/current/ml-get-trained-model-deployment-stats.html
     */
    public function getTrainedModelDeploymentStats(array $params = [])
    {
        $model_id = $this->extractArgument($params, 'model_id');

        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('Ml\GetTrainedModelDeploymentStats');
        $endpoint->setParams($params);
        $endpoint->setModelId($model_id);
     ...
     *
     * $params['model_id'] = (string) The unique identifier of the trained model.
     * $params['timeout']  = (time) Controls the amount of time to wait for inference results. (Default = 10s)
     * $params['body']     = (array) The docs to apply inference on (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
    ...
    public function inferTrainedModelDeployment(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('Ml\InferTrainedModelDeployment');
        $endpoint->setParams($params);
        $endpoint->setModelId($model_id);
        $endpoint->setBody($body);
     ...
     *
     * $params['model_id'] = (string) The ID of the trained model for this definition part
     * $params['part']     = (int) The part number
     * $params['body']     = (array) The trained model definition part (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
    ...
    {
        $model_id = $this->extractArgument($params, 'model_id');
        $part = $this->extractArgument($params, 'part');
        $body = $this->extractArgument($params, 'body');

        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('Ml\PutTrainedModelDefinitionPart');
        $endpoint->setParams($params);
        $endpoint->setModelId($model_id);
        $endpoint->setPart($part);
        $endpoint->setBody($body);
     ...
     *
     * $params['model_id'] = (string) The ID of the trained model for this vocabulary
     * $params['body']     = (array) The trained model vocabulary (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
    ...
    public function putTrainedModelVocabulary(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('Ml\PutTrainedModelVocabulary');
        $endpoint->setParams($params);
        $endpoint->setModelId($model_id);
        $endpoint->setBody($body);
     ...
     *
     * $params['model_id'] = (string) The unique identifier of the trained model.
     * $params['timeout']  = (time) Controls the amount of time to wait for the model to deploy. (Default = 20s)
     * $params['wait_for'] = (string) The allocation status for which to wait (Options = starting,started,fully_allocated) (Default = started)
     *
     * @param array $params Associative array of parameters
     * @return array
    ...
    public function startTrainedModelDeployment(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('Ml\StartTrainedModelDeployment');
        $endpoint->setParams($params);
        $endpoint->setModelId($model_id);
    ...
    public function stopTrainedModelDeployment(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('Ml\StopTrainedModelDeployment');
        $endpoint->setParams($params);
        $endpoint->setModelId($model_id);
