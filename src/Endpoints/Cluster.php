...
class Cluster extends AbstractEndpoint
{
	 ...
	 *
	 * @param array{
	 *     name?: string, // The comma separated names of the component templates
	 *     master_timeout?: int|string, // Explicit operation timeout for connection to master node
	 *     local?: bool, // Return local information, do not retrieve the state from master node (default: false)
	 ...
	 *
	 * @param array{
	 *     target: string, // (REQUIRED) Limit the information returned to the specified target.
	 *     pretty?: bool, // Pretty format the returned JSON response. (DEFAULT: false)
	 *     human?: bool, // Return human readable values for statistics. (DEFAULT: true)
	 *     error_trace?: bool, // Include the stack trace of returned errors. (DEFAULT: false)
	 *     source?: string, // The URL-encoded request definition. Useful for libraries that do not accept a request body for non-POST requests.
	 ...
	 *     metric?: string, // Limit the information returned to the specified metrics. Defaults to all but metadata
	 *     master_timeout?: int|string, // Explicit operation timeout for connection to master node
	 *     timeout?: int|string, // Explicit operation timeout
	 *     pretty?: bool, // Pretty format the returned JSON response. (DEFAULT: false)
	 *     human?: bool, // Return human readable values for statistics. (DEFAULT: true)
	 ...
	 *     master_timeout?: int|string, // Specify timeout for connection to master
	 *     flat_settings?: bool, // Return settings in flat format (default: false)
	 *     wait_for_metadata_version?: float, // Wait for the metadata version to be equal or greater than the specified metadata version
