...
class Eql extends AbstractEndpoint
{
	 ...
	 *
	 * @link https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-eql-delete
	 * @group serverless
	 *
	 * @param array{
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-eql-search-api.html
	 * @group serverless
	 *
	 * @param array{
	 *     id: string, // (REQUIRED) The async search ID
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-eql-status-api.html
	 * @group serverless
	 *
	 * @param array{
	 *     id: string, // (REQUIRED) The async search ID
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/8.19/eql-search-api.html
	 * @group serverless
	 *
	 * @param array{
	 ...
	 *     allow_partial_search_results?: bool, // If true, returns partial results if there are shard failures. If false, returns an error with no partial results.
	 ...
	 *     ignore_unavailable?: bool, // If true, missing or closed indices are not included in the response. (DEFAULT: 1)
