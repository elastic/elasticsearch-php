...
class Esql extends AbstractEndpoint
{
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/master/esql-async-query-api.html
	 *
	 * @param array{
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/master/esql-async-query-delete-api.html
	 *
	 * @param array{
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/master/esql-async-query-get-api.html
	 *
	 * @param array{
	 *     id: string, // (REQUIRED) The async query ID
	 *     format?: string, // a short version of the Accept header, e.g. json, yaml
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/master/esql-async-query-stop-api.html
	 *
	 * @param array{
	 *     id: string, // (REQUIRED) The async query ID
	 *     pretty?: bool, // Pretty format the returned JSON response. (DEFAULT: false)
