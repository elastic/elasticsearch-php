...
class Nodes extends AbstractEndpoint
{
	 ...
	 *
	 * @param array{
	 *     node_id: string, // (REQUIRED) Comma-separated list of node IDs or names used to limit returned information.
	 ...
	 *
	 * @param array{
	 *     node_id: string, // (REQUIRED) A comma-separated list of node IDs or names to limit the returned information.
	 *     pretty?: bool, // Pretty format the returned JSON response. (DEFAULT: false)
	 *     human?: bool, // Return human readable values for statistics. (DEFAULT: true)
	 *     error_trace?: bool, // Include the stack trace of returned errors. (DEFAULT: false)
	 *     source?: string, // The URL-encoded request definition. Useful for libraries that do not accept a request body for non-POST requests.
	 ...
	 *
	 * @param array{
	 *     node_id?: string, // A comma-separated list of node IDs or names to limit the returned information; use `_local` to return information from the node you're connecting to, leave empty to get information from all nodes
	 *     interval?: int|string, // The interval for the second sampling of threads
	 *     snapshots?: float, // Number of samples of thread stacktrace (default: 10)
	 *     threads?: float, // Specify the number of threads to provide information for (default: 3)
	 ...
	 * @param array{
	 *     node_id?: string, // A comma-separated list of node IDs or names to limit the returned information; use `_local` to return information from the node you're connecting to, leave empty to get information from all nodes
	 *     metric?: string, // A comma-separated list of metrics you wish returned. Use `_all` to retrieve all metrics and `_none` to retrieve the node identity without any additional metrics.
	 ...
	 *
	 * @param array{
	 *     node_id?: string, // A comma-separated list of node IDs to span the reload/reinit call. Should stay empty because reloading usually involves all cluster nodes.
	 *     timeout?: int|string, // Explicit operation timeout
	 *     pretty?: bool, // Pretty format the returned JSON response. (DEFAULT: false)
	 *     human?: bool, // Return human readable values for statistics. (DEFAULT: true)
	 *     error_trace?: bool, // Include the stack trace of returned errors. (DEFAULT: false)
	 *     source?: string, // The URL-encoded request definition. Useful for libraries that do not accept a request body for non-POST requests.
	 *     filter_path?: string, // A comma-separated list of filters used to reduce the response.
	 *     body?: string|array, // An object containing the password for the elasticsearch keystore. If body is a string must be a valid JSON.
	 * } $params
	 *
	 * @throws NoNodeAvailableException if all the hosts are offline
	 * @throws ClientResponseException if the status code of response is 4xx
	 ...
	 * @param array{
	 *     node_id?: string, // A comma-separated list of node IDs or names to limit the returned information; use `_local` to return information from the node you're connecting to, leave empty to get information from all nodes
	 *     metric?: string, // Limit the information returned to the specified metrics
	 *     index_metric?: string, // Limit the information returned for `indices` metric to the specific index metrics. Isn't used if `indices` (or `all`) metric isn't specified.
