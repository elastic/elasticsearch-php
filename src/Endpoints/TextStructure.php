...
class TextStructure extends AbstractEndpoint
{
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/current/find-field-structure.html
	 *
	 * @param array{
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/current/find-message-structure.html
	 *
	 * @param array{
	 *     timeout?: int|string, // Timeout after which the analysis will be aborted
	 *     format?: string, // Optional parameter to specify the high level file format
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/current/find-structure.html
	 *
	 * @param array{
	 ...
	 *
	 * @link https://www.elastic.co/guide/en/elasticsearch/reference/master/test-grok-pattern.html
	 *
	 * @param array{
	 *     ecs_compatibility?: string, // Optional parameter to specify the compatibility mode with ECS Grok patterns - may be either 'v1' or 'disabled'
	 *     pretty?: bool, // Pretty format the returned JSON response. (DEFAULT: false)
