...
class YamlTests
{
    ...
    const SKIPPED_TEST_XPACK = [
        ...
        'Ml\_Get_Trained_Model_StatsTest::TestGetStatsGivenExpressionWithoutMatchesAndAllow_no_matchIsFalse' => 'cannot assign model_alias',
        'Ml\_Get_Trained_Model_StatsTest::TestGetStatsGivenExpressionWithoutMatchesAndAllow_no_matchIsTrue' => 'cannot assign model_alias',
